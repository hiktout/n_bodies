...
from .barycentre import find_barycentre
...
def quartiles(n):
	...
	r = dot(r,r)
	r = numpy.sort(r)
	r_1 = numpy.sqrt(r[round(n.n/4)-1])
	r_2 = numpy.sqrt(r[round(n.n/2)-1])
	r_3 = numpy.sqrt(r[round(3*n.n/4)-1])
	r_4 = numpy.sqrt(r[n.n-1])
