...
class TestNbodiesClass(unittest.TestCase):
	...
	def test_find_r(self):
		...
		assert_allclose(self.n_bodies.r_u,find_r_u(self.n,self.x))
		assert_allclose(self.n_bodies.r_norm2_u,find_r_norm2_u(self.n,self.x))

	def test_find_a(self):
		self.n_bodies.find_r()
		self.n_bodies.find_a()

		assert_allclose(self.n_bodies.F_u,find_F_u(self.n,self.m,self.x,self.v,self.s))
